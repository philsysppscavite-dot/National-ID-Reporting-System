"""Barangay lists per Cavite city/municipality, sourced from the
province's TRN Daily Logsheet template (Classification Guide and
Dropdown sheet). Keys match CITY_MUNICIPALITIES in repository.py
exactly so the data entry form can look barangays up by the
selected city.
"""

from __future__ import annotations

BARANGAYS_BY_CITY: dict[str, list[str]] = {
    'ALFONSO': [
        'Amuyong',
        'Barangay I (Pob.)',
        'Barangay II (Pob.)',
